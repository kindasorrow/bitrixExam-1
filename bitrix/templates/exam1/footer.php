	...
	false
					...
					<?$APPLICATION->IncludeComponent("bitrix:main.include", "include_block", Array(
	...
	false
                    ...
                    <div class="side-wrap">
                       ...
                       <div class="item-wrap">
					   <?$APPLICATION->IncludeComponent("bitrix:news.list", "rew_preview", Array(
